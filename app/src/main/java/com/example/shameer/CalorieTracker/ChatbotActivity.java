...
import static io.kommunicate.Kommunicate.*;
import static io.kommunicate.Kommunicate.launchConversationWithPreChat;
...
public class ChatbotActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visitorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setCancelable(false);
                progressDialog.show();
                init(ChatbotActivity.this, APP_ID);
                launchConversationWithPreChat(ChatbotActivity.this, progressDialog, new KmCallback() {
                    @Override
            ...
            private void launchConversationWithPreChat(ChatbotActivity chatbotActivity, ProgressDialog progressDialog, KmCallback kmCallback) {
            }
        });
    }

    public boolean isPlaceHolderAppId() {
        if (PLACEHOLDER_APP_ID.equals(APP_ID)) {
    ...
    public void initLoginData(String userId, String password, final ProgressDialog progressDialog) {
        ...
        login(ChatbotActivity.this, user, new KMLoginHandler() {
            @Override
